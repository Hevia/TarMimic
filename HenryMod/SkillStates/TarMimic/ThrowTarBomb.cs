...
namespace TarMimic.SkillStates
{
    public class ThrowTarBomb : GenericProjectileBaseState
    {
        ...
        private int numBombs = Modules.StaticValues.numberTarBombs;

        public static GameObject oilPrefab = ((GenericProjectileBaseState)new ThrowBarrel()).projectilePrefab;

        public override void OnEnter()
        {
            numBombs += base.characterBody.GetBuffCount(Modules.Buffs.bombBuff);
            ...
            base.damageCoefficient = Modules.StaticValues.tarBombDamageCoeff;
